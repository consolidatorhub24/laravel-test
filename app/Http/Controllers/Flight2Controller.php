...
use Amadeus\Client\RequestOptions\TicketGetQuotationDetailsOptions;
...
class AgentFlightController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $params = new Params([
            ...
            'sessionHandlerParams' => [
                ...
                'wsdl' => base_path('/public/wsdl/1ASIWCLI7HZ_PDT_20220413_131234.wsdl'),
                'stateful' => false,
                'logger' => $msgLog,
            ],
    ...
    public function CheckIfUserIsAuthenticated()
    {
        ...
        //             'date' => new MPDate([
        //                 'dateTime' => new \DateTime('2022-06-15T00:00:00+0000', new \DateTimeZone('UTC'))
        //             ])
        //         ]),
        //     ],
        //     'flightOptions' => [
        ...
        //             'segments' => [
        //                 new sellSegment([
        //                     'departureDate' => \DateTime::createFromFormat('Y-m-d H:i:s', '2022-06-15 20:50:00'),
        //                     'from' => 'NBO',
        //                     'to' => 'KGL',
        //                     'companyCode' => 'WB',
        //                     'flightNumber' => '403',
        ...
        //                     'company' => 'KQ',
        //                     'date' => \DateTime::createFromFormat('Ymd', '20220615', new \DateTimeZone('UTC')),
        //                     'cityCode' => 'NBO',
        ...
        // // //==================================BookingClass===============================================================
        // $pricingResponse1 = $this->client->farePricePnrWithBookingClass(
        //     new FarePricePnrWithBookingClassOptions([
        //         'overrideOptions' => [
        //             PricingOptions::OVERRIDE_FARETYPE_PUB,
        //             PricingOptions::OVERRIDE_FARETYPE_UNI,
        ...
        //     new PnrRetrieveOptions(['recordLocator' => 'JE6W78'])
        // );
        ...
        // dd($this->client->getLastRequest());
         ...
         //////////////TICKET GETQUOTATION DETAILS/////////////////////////////////
        $this->client->setStateful(true);

        $pnrcontent4 = $this->client->pnrRetrieveAndDisplay(
            new PnrRetrieveAndDisplayOptions([
                'recordLocator' => 'JE6W78',
                'retrieveOption' => PnrRetrieveAndDisplayOptions::RETRIEVEOPTION_ALL
            ])
        ...
        $ticket_quotation = $this->client->ticketGetQuotationDetails(
            new TicketGetQuotationDetailsOptions([
                'referenceType' => TicketGetQuotationDetailsOptions::REF_TYPE_PQR,
                'tattooNumber' => 1
            ])
        );
        $this->client->securitySignOut();
